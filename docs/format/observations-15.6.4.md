...
| HSL static writer acceptance | replace existing Orange Saturation 15 with 27, open and Save As | generated copy and Filmora round trip retained `Orange_satVal: 27.0`; first-use/keyframes remain unsupported |
