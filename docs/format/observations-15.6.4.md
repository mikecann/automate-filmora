...
| vertical flip repeat | toggle an existing vertical flip off and back on | same two-part state as horizontal under `video/effect/vertical_filp`; insertion remains unverified |
